...
**Notes:**
* *<sup>1</sup> Function for Shopware 5 had a bug until v0.22 where a wrong version number was returned. Please consider upgrading the satellite to at leas v0.22 if you encountered that issue.
